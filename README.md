...
>
> This package continues as **`naf/session`**:
> [github.com/nafphp/session](https://github.com/nafphp/session) ·
...
> releases; `nixphp/session` stays on Packagist so existing installations keep working.
>
